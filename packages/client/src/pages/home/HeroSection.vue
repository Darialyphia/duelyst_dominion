...
.hero-section {
  ...
  padding: var(--size-13) var(--size-4) var(--size-10);
}
...
.hero-tagline {
  ...
  color: #c9c9c9;
  text-shadow: 2px 2px 8px hsl(240 100% 5% / 0.8);
}
...
.card-phantom {
  ...
  --pixel-size: 2;
  box-shadow:
    0 8px 25px hsl(240 100% 5% / 0.8),
    inset 0 1px 3px hsl(45 100% 50% / 0.2);
  animation: landing-card 0.8s var(--ease-elastic-in-out-4);
}
